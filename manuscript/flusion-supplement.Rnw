...
This document provides supplemental analyses and results for the Flusion manuscript. Section \ref{sec:flusurv_burden_adj} describes the approach we use to adjusting the FluSurv-NET data to account for testing rates and test sensitivity in that surveillance system.  Section \ref{sec:feats} describes the features used in the GBQR model that summarize local behavior of the target surveillance signal. Section \ref{sec:feature_importance} presents results about the importance of the features used by the GBQR model. Section \ref{sec:flusight_plots} contains plots of real-time forecasts produced by Flusion, the FluSight ensemble, and the baseline models in all locations. Section \ref{sec:flusight_wis_by_horizon} shows mean weighted interval scores broken down by the forecast horizon. Sections \ref{sec:flusight_sensitivity} and \ref{sec:experiments_sensitivity} describe sensitivity analyses investigating whether the forecast evaluation results in the main text are impacted by data revisions.
...
\section{FluSight results: plots of forecasts for all locations}
\label{sec:flusight_plots}

Figure 3 in the main text showed plots of forecasts from the baseline models, the FluSight ensemble, and the Flusion model for the 6 states with the largest total reported influenza hospitalizations over the course of the 2023/24 season. Supplemental figures 3 through 8 show these forecasts for all states.

\begin{figure}[!htp]
    \centering
    \includegraphics[width=\textwidth]{../artifacts/figures/forecasts_flusight_all_models_p1.pdf}
    \caption{Influenza data and forecasts for 9 state-level jurisdictions. Accross supplemental figures 3 through 8 and within each figure, states are shown in decreasing order of cumulative hospital admissions during the 2023/24 season. To avoid overplotting, in this figure forecasts from every fourth reference date are shown; evaluations include all reference dates. Forecasts are represented by the predictive median (black lines) and 50\% and 95\% prediction intervals (blue shaded regions). Solid orange lines show the finalized admission counts reported as of May 1, 2024, while dotted orange lines show the initial reported values that were available on the date predictions were generated.}
    \label{fig:forecasts_flusight_1}
\end{figure}

\begin{figure}[!htp]
    \centering
    \includegraphics[width=\textwidth]{../artifacts/figures/forecasts_flusight_all_models_p2.pdf}
    \caption{Influenza data and forecasts for 9 state-level jurisdictions. Accross supplemental figures 3 through 8 and within each figure, states are shown in decreasing order of cumulative hospital admissions during the 2023/24 season. To avoid overplotting, in this figure forecasts from every fourth reference date are shown; evaluations include all reference dates. Forecasts are represented by the predictive median (black lines) and 50\% and 95\% prediction intervals (blue shaded regions). Solid orange lines show the finalized admission counts reported as of May 1, 2024, while dotted orange lines show the initial reported values that were available on the date predictions were generated.}
    \label{fig:forecasts_flusight_2}
\end{figure}

\begin{figure}[!htp]
    \centering
    \includegraphics[width=\textwidth]{../artifacts/figures/forecasts_flusight_all_models_p3.pdf}
    \caption{Influenza data and forecasts for 9 state-level jurisdictions. Accross supplemental figures 3 through 8 and within each figure, states are shown in decreasing order of cumulative hospital admissions during the 2023/24 season. To avoid overplotting, in this figure forecasts from every fourth reference date are shown; evaluations include all reference dates. Forecasts are represented by the predictive median (black lines) and 50\% and 95\% prediction intervals (blue shaded regions). Solid orange lines show the finalized admission counts reported as of May 1, 2024, while dotted orange lines show the initial reported values that were available on the date predictions were generated.}
    \label{fig:forecasts_flusight_3}
\end{figure}

\begin{figure}[!htp]
    \centering
    \includegraphics[width=\textwidth]{../artifacts/figures/forecasts_flusight_all_models_p4.pdf}
    \caption{Influenza data and forecasts for 9 state-level jurisdictions. Accross supplemental figures 3 through 8 and within each figure, states are shown in decreasing order of cumulative hospital admissions during the 2023/24 season. To avoid overplotting, in this figure forecasts from every fourth reference date are shown; evaluations include all reference dates. Forecasts are represented by the predictive median (black lines) and 50\% and 95\% prediction intervals (blue shaded regions). Solid orange lines show the finalized admission counts reported as of May 1, 2024, while dotted orange lines show the initial reported values that were available on the date predictions were generated.}
    \label{fig:forecasts_flusight_4}
\end{figure}

\begin{figure}[!htp]
    \centering
    \includegraphics[width=\textwidth]{../artifacts/figures/forecasts_flusight_all_models_p5.pdf}
    \caption{Influenza data and forecasts for 9 state-level jurisdictions. Accross supplemental figures 3 through 8 and within each figure, states are shown in decreasing order of cumulative hospital admissions during the 2023/24 season. To avoid overplotting, in this figure forecasts from every fourth reference date are shown; evaluations include all reference dates. Forecasts are represented by the predictive median (black lines) and 50\% and 95\% prediction intervals (blue shaded regions). Solid orange lines show the finalized admission counts reported as of May 1, 2024, while dotted orange lines show the initial reported values that were available on the date predictions were generated.}
    \label{fig:forecasts_flusight_5}
\end{figure}

\begin{figure}[!htp]
    \centering
    \includegraphics[width=\textwidth]{../artifacts/figures/forecasts_flusight_all_models_p6.pdf}
    \caption{Influenza data and forecasts for 7 state-level jurisdictions. Accross supplemental figures 3 through 8 and within each figure, states are shown in decreasing order of cumulative hospital admissions during the 2023/24 season. To avoid overplotting, in this figure forecasts from every fourth reference date are shown; evaluations include all reference dates. Forecasts are represented by the predictive median (black lines) and 50\% and 95\% prediction intervals (blue shaded regions). Solid orange lines show the finalized admission counts reported as of May 1, 2024, while dotted orange lines show the initial reported values that were available on the date predictions were generated.}
    \label{fig:forecasts_flusight_6}
\end{figure}

\section{FluSight results: weighted interval scores by forecast horizon}
\label{sec:flusight_wis_by_horizon}

Figure \ref{fig:wis_by_horizon} shows the mean WIS for models contributing to FluSight in the 2023/24 season, broken down by forecast horizon. For all models, weighted interval scores increased with larger forecast horizons, indicating lower forecast accuracy. 

\begin{figure}[!htp]
    \centering
    \includegraphics[width=\textwidth]{../artifacts/figures/scores_flusight_wis_by_horizon.pdf}
    \caption{Mean weighted interval scores by model and forecast horizon for models that contributed forecasts for at least 75\% of predictions over the course of the 2023/24 season. Mean scores average across forecasts for multiple reference dates and forecast horizons.}
    \label{fig:wis_by_horizon}
\end{figure}
