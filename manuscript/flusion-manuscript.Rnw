...
We also investigated the feature importances. TODO

\section{Discussion}

contemporaneous use of multiple signals

other possible signals -- quidel, insurance claims

vaccine uptake and efficacy

better handling of holiday effects and the possibility of a second peak

flu strain data -- how to use, laggy?

improvements to ARX model
